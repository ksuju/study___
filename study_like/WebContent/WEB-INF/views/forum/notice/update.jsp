            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="question-form cardify p-4">
                        <form id="myForm" action="listPage.do" method="POST">
                            <div class="form-group">
                                <label>제목</label>
                                <input type="text" value="${board.title}" name="updateTitle" placeholder="Enter title here" required>
                                <input type="hidden" value="${board.boardSeq}" name="updateBoardSeq"/>
                            </div>
                            <div class="form-group">
